  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(futbolApp, [{
    ...
    value: function componentDidMount() {
      ...
      window.onscroll = function () {
        var newScrollHeight = Math.ceil(window.scrollY / 50) * 50;

        if (_this2.state.currentScrollHeight != newScrollHeight) {
          _this2.setState({
    ...
    value: function render() {
      ...
      var opacity = Math.min(100 / this.state.currentScrollHeight, 1);
...
//# sourceMappingURL=index.js.4e2f5ee92fe3b0ca9957.hot-update.js.map